...
**Context**: RMM (Resource-based Memory Manager) is a C++ library providing GPU memory allocators and memory resources for CUDA applications. It provides RAII-based device memory management, memory pools, and custom allocator interfaces used throughout NVIDIA CUDA-X libraries for data science.
