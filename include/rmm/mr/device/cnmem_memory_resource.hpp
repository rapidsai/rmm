...
class cnmem_memory_resource : public device_memory_resource {
 ...
 private:
   ...
   */
  void do_deallocate(void* p, std::size_t, cuda_stream_view stream) override
  {
   ...
   */
  void register_stream(cuda_stream_view stream)
  {
  ...
  std::set<cuda_stream_view> registered_streams{};  // Unique streams that have been
