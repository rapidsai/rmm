...
class cnmem_memory_resource : public device_memory_resource {
 ...
 private:
   ...
   */
  void do_deallocate(void* p, std::size_t, stream_view stream) override
  {
   ...
   */
  void register_stream(stream_view stream)
  {
  ...
  std::set<stream_view> registered_streams{};  // Unique streams that have been
