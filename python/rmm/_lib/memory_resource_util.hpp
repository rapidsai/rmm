...
class cuda_memory_resource : public device_memory_resource {
 public:
  cuda_memory_resource() : mr(std::make_shared<rmm::mr::cuda_memory_resource>()) {}
...
class managed_memory_resource : public device_memory_resource {
 public:
  managed_memory_resource() : mr(std::make_shared<rmm::mr::managed_memory_resource>()) {}
...
class cnmem_memory_resource : public device_memory_resource {
 public:
  cnmem_memory_resource(std::size_t initial_pool_size = 0, std::vector<int> const& devices = {})
...
class cnmem_managed_memory_resource : public device_memory_resource {
 public:
  cnmem_managed_memory_resource(std::size_t initial_pool_size   = 0,
...
class pool_memory_resource : public device_memory_resource {
 public:
  pool_memory_resource(std::shared_ptr<device_memory_resource> upstream_mr,
 ...
 private:
  std::shared_ptr<device_memory_resource> upstream_mr;
...
class fixed_size_memory_resource : public device_memory_resource {
 public:
  fixed_size_memory_resource(std::shared_ptr<device_memory_resource> upstream_mr,
...
class hybrid_memory_resource : public device_memory_resource {
 public:
  hybrid_memory_resource(std::shared_ptr<device_memory_resource> small_alloc_mr,
                         std::shared_ptr<device_memory_resource> large_alloc_mr,
 ...
 private:
  std::shared_ptr<device_memory_resource> small_alloc_mr;
  std::shared_ptr<device_memory_resource> large_alloc_mr;
...
class logging_resource_adaptor : public device_memory_resource {
 public:
  logging_resource_adaptor(std::shared_ptr<device_memory_resource> upstream_mr,
...
void
set_default_resource(std::shared_ptr<device_memory_resource> new_resource) {
