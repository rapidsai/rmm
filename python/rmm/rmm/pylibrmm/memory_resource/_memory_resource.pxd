...
cdef class ArenaMemoryResource(UpstreamResourceAdaptor):
    cdef unique_ptr[arena_memory_resource[any_device_resource]] _typed_mr
...
cdef class PoolMemoryResource(UpstreamResourceAdaptor):
    cdef unique_ptr[pool_memory_resource[any_device_resource]] _typed_mr

cdef class FixedSizeMemoryResource(UpstreamResourceAdaptor):
    cdef unique_ptr[fixed_size_memory_resource[any_device_resource]] _typed_mr

cdef class BinningMemoryResource(UpstreamResourceAdaptor):
    cdef unique_ptr[binning_memory_resource[any_device_resource]] _typed_mr
...
cdef class LimitingResourceAdaptor(UpstreamResourceAdaptor):
    cdef unique_ptr[limiting_resource_adaptor[any_device_resource]] _typed_mr

cdef class LoggingResourceAdaptor(UpstreamResourceAdaptor):
    cdef unique_ptr[logging_resource_adaptor[any_device_resource]] _typed_mr
    cdef object _log_file_name
    cpdef get_file_name(self)
    cpdef flush(self)

cdef class StatisticsResourceAdaptor(UpstreamResourceAdaptor):
    cdef unique_ptr[statistics_resource_adaptor[any_device_resource]] _typed_mr

cdef class TrackingResourceAdaptor(UpstreamResourceAdaptor):
    cdef unique_ptr[tracking_resource_adaptor[any_device_resource]] _typed_mr

cdef class FailureCallbackResourceAdaptor(UpstreamResourceAdaptor):
    cdef unique_ptr[
        failure_callback_resource_adaptor[any_device_resource]
    ] _typed_mr
    cdef object _callback

cdef class PrefetchResourceAdaptor(UpstreamResourceAdaptor):
    cdef unique_ptr[prefetch_resource_adaptor[any_device_resource]] _typed_mr
